...
async function seed() {
  ...
  const [
  ...
  ] = await Operator.insertMany([
    {
      ...
      type: "bus",
      contact: {
        email: "contact@shreetravels.com",
        phone: "9000000001"
      },
      rating: 4.3,
      isVerified: true
    ...
    },
    {
      ...
      type: "bus",
      contact: {
        email: "contact@royalcruiser.com",
        phone: "9000000008"
      },
      rating: 4.4,
      isVerified: true
    ...
    {
      name: "Group Tour Vans",
      type: "tempo",
      contact: {
        email: "contact@grouptours.com",
        phone: "9000000006"
      },
      rating: 4.4,
      isVerified: true
    ...
    {
      name: "Zoom Self Drive",
      type: "car",
      contact: {
        email: "contact@zoomcabs.com",
        phone: "9000000007"
      },
      rating: 4.0,
      isVerified: true
  ...
  console.log("[Seed] Operators created:", 9);
  ...
  const [
    delhiJaipurRoute,
    vrlDelhiJaipurRoute,
    royalDelhiJaipurRoute,
    greenlineDelhiJaipurRoute,
    delhiMumbaiTrainRoute,
    mumbaiGoaFerryRoute
  ] = await Route.insertMany([
    {
      ...
      source: {
        city: "Delhi",
        terminal: "Kashmiri Gate ISBT",
        lat: 28.6667,
        lng: 77.2167
      },
      destination: {
        city: "Jaipur",
        terminal: "Sindhi Camp",
        lat: 26.9124,
        lng: 75.7873
      },
      distanceKm: 280,
...

    {
      ...
      source: {
        city: "Delhi",
        terminal: "New Delhi Railway Station",
        lat: 28.6431,
        lng: 77.2197
      },
      destination: {
        city: "Mumbai",
        terminal: "Mumbai Central",
        lat: 18.9696,
        lng: 72.8194
      },
      distanceKm: 1384,
      ...
      stops: [
        {
          city: "Kota",
          arrivalOffsetMin: 300
        },
        {
          city: "Vadodara",
          arrivalOffsetMin: 720
        }
      ]
    },

    {
      ...
      source: {
        city: "Mumbai",
        terminal: "Gateway of India",
        lat: 18.922,
        lng: 72.8347
      },
      destination: {
        city: "Goa",
        terminal: "Panaji Jetty",
        lat: 15.4989,
        lng: 73.8278
      },
      distanceKm: 460,
  ...
  console.log("[Seed] Routes created:", 6);
  ...
  await Bus.create({
    ...
    departureTime: new Date("2026-08-08T12:44:00"),
    arrivalTime: new Date("2026-08-08T18:14:00"),
    basePrice: 800,
    status: "scheduled"
  });
  ...
  await Bus.create({
    operatorId: vrlTravels._id,
    routeId: vrlDelhiJaipurRoute._id,
    ...
    departureTime: new Date("2026-08-09T13:00:00"),
    arrivalTime: new Date("2026-08-09T18:45:00"),
    basePrice: 500,
    status: "scheduled"
  });

  // 10 Aug - Royal Cruiser
  await Bus.create({
    operatorId: royalCruiser._id,
    routeId: royalDelhiJaipurRoute._id,
    busNumber: "RJ14-RC-7890",
    busType: "AC Seater",
    totalSeats: 36,

    seatLayout: Array.from({ length: 36 }, (_, i) => ({
      seatNumber: "S" + (i + 1),
      type: "seater",
      isAvailable: true,
      price: 650,
    ...
    departureTime: new Date("2026-08-10T14:00:00"),
    arrivalTime: new Date("2026-08-10T19:30:00"),
    basePrice: 650,
    status: "scheduled"
  });
  ...
  await Bus.create({
    operatorId: greenline._id,
    routeId: greenlineDelhiJaipurRoute._id,
    busNumber: "RJ14-GL-4567",
    busType: "Sleeper",
    totalSeats: 30,
    ...
    amenities: ["WiFi", "Charging Point", "Blanket"],
    departureTime: new Date("2026-08-11T15:00:00"),
    arrivalTime: new Date("2026-08-11T20:30:00"),
    basePrice: 700,
    status: "scheduled"
  });

  console.log("[Seed] Buses created:", 4);
  ...
  console.log("[Seed] Flight created: 1");
  ...
  console.log("[Seed] Train created: 1");
  ...
  console.log("[Seed] Ferry created: 1");
  ...
  console.log("[Seed] Cars created: 2");
  ...
  console.log("[Seed] Tempo Traveller created: 1");
  ...
  console.log("[Seed] Drivers created: 2");
